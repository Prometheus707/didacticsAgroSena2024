...
<div class="page-content p-5" id="content">
  <!-- Toggle button -->
   ...
   <h4 class="" style="float:left; font-size:5vh;font-size:2.5vw;   " > Jolts y Motivadores</h4>
	  <a href="motivadores.php"> <button style="float:right" width="60%" class="btn btn-danger text-light " > &nbsp&nbsp&nbsp Volver &nbsp&nbsp&nbsp </button></a>
...
<div class="w3-content w3-white" style="width:100%; display:table">
  ...
  <div class="w3-row w3-padding w3-border" style="margin-bottom: 5rem;">
   ...
   <form action="buscarJolts.php" method="get" >
       ...
       <button style="float:left; margin-left:5px; margin-top:1%; " name="b1"  class="btn btn-outline-warning ">Buscar </button>   
        ...
        <a  href="motivadores.php" >   <button style="float:left; margin-left:5px;  margin-top:-1.5%; "  type="button" class="btn btn-warning text-dark " > Mostrar todas </button></a>
</div><br><br>

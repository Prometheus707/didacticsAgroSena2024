...
<head>
    <meta charset="UTF-8">
    <title>Frases en positivo para usar</title>
...
<div class="page-content p-5" id="content">
  <!-- Toggle button -->
    ...
    Es fundamental comprender que las palabras tienen poder. Por medio
de la palabra acompañado del ejemplo, un Instructor puede guiar a
sus aprendices a convertirse en lo que pueden y deben ser. Cuando el
profesor dice a un estudiante &quot;¡Puedes hacerlo!&quot; genera en él una
herramienta de auto- motivación para lograr hacer lo que a un inicio le
parecía muy difícil conseguir, ya que le brinda la seguridad de que hay
alguien más que no solamente confía en él, sino que lo anima en el
proceso.
Aristóteles decía &quot;Somos lo que hacemos día a día. De modo que la
excelencia no es un acto, sino un hábito&quot;. Entonces, si la inspiración y
el entusiasmo son el alma de una institución educativa, ésta se
extingue si no la alimentamos con &quot;nutrientes mentales&quot;. Es necesario,
por tanto, nutrir a nuestros aprendices, día a día con un lenguaje
positivo de forma que se convierta en un hábito que sea favorable
para el desarrollo de la excelencia personal y para despertar una
mentalidad de superación. Convencernos nosotros mismos de que sí
se puede lograr un cambio, de que poseemos capacidades y
competencias para lograr tener la mejor versión de cada uno.
    </p>			
	</div>
  ...
  <div class="row  w3-white">
      ...
      <form action="buscarfrases.php" method="get" class="form-inline my-2 my-lg-0" >

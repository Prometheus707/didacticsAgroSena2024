...
<head>
    <meta charset="UTF-8">
    <title> Buscar Inicio De Sesión</title>
...
<div class="w3-content w3-white" style="width:100%; display:table">
  ...
  <form action="buscarfrases.php" method="get" >
       ...
       <button style="float:left; margin-left:5px; margin-top:1%; " name="b1"  class="btn btn-outline-warning ">Buscar </button>   
        ...
        <a  href="frases.php" >   <button style="float:left; margin-left:5px;  margin-top:-1.5%; "  type="button" class="btn btn-warning text-dark " > Mostrar todas </button></a>
</div><br><br>
      ...
      <div id="tablephp">
        <?php
              ...
              if ($resultado->num_rows > 0 ){
                  ...
                  <td> 
                  <a href=../pdf/".$fila["pdfFrases"]."><img src='../images/ver.png' width='100%'></a></td>

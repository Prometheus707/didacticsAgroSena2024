...
<div class="page-content p-5" id="content">
  <!-- Toggle button -->
   ...
   <h4 class="" style="float:left; font-size:5vh;font-size:2.5vw;   " >Reflexiones Estructuradas y Cierres</h4>
	  <a href="reflexionCierre.php"> <button style="float:right" width="60%" class="btn btn-danger text-light " > &nbsp&nbsp&nbsp Volver &nbsp&nbsp&nbsp </button></a>
...
<div class="w3-content w3-white" style="width:100%; display:table">
  ...
  <div class="w3-row w3-padding w3-border">
   ...
   <form action="buscarCierresPdf.php" method="get" >
       ...
       <button style="float:left; margin-left:5px; margin-top:1%; " name="b1"  class="btn btn-outline-warning ">Buscar </button>   
        ...
        <a  href="reflexionCierre.php" >   <button style="float:left; margin-left:5px;  margin-top:-1.5%; "  type="button" class="btn btn-warning text-dark " > Mostrar todas </button></a>
</div><br><br>
        ...
        <?php
                ...
                echo "<table border='1'  class='table table-bordered table-hover'>
                 <thead> <tr>
                   ...
                   <th class='t4' >Archivo</th>
                   <th class='t4' >Anexo</th>
              ...
              where
              TituloRefPdf like '%$busqueda%' OR
              descripcionRefPdf like '%$busqueda%'
              ";
              ...
              if ($resultado->num_rows > 0 ){
                  ...
                  while($fila = $resultado->fetch_assoc()) {
                    $varCadena = strlen ($fila["anexoR"]);
                    if($varCadena>0)
                    {
                      $enlaceHref = " <a href=../pdf/".$fila["anexoR"]."> ";
                  ...
                  <td> ".$fila["TituloRefPdf"]."</td>
                  <td> ".$fila['descripcionRefPdf']."</td>
                  <td> 
                  <a href=../pdf/".$fila["pdfRefC"]."><img src='../images/ver.png' width='100%'></a></td>

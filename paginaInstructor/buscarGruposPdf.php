...
<div class="page-content p-5" id="content">
  <!-- Toggle button -->
   ...
   <h4 class="" style="float:left; font-size:5vh;font-size:2.5vw;   " >Formas De Conformar Grupos
</h4>
   ...
   <form action="buscarCierresPdf.php" method="get" >
      ...
      <div id="tablephp">
        <?php
              ...
              $consulta = "SELECT * FROM conformargpdf
              where
              nombreConforPdf like '%$busqueda%' OR
              descripcionCoPdf like '%$busqueda%'
              ";
              ...
              if ($resultado->num_rows > 0 ){
                  while($fila = $resultado->fetch_assoc()) {
                    $varCadena = strlen ($fila["anexoConFor"]);
                    if($varCadena>0)
                    {
                      $enlaceHref = " <a href=../pdf/".$fila["anexoConFor"]."> ";
                  ...
                  <td> ".$fila["nombreConforPdf"]."</td>
                  <td> ".$fila['descripcionCoPdf']."</td>
                  <td> 
                  <a href=../pdf/".$fila["pdfConfor"]."><img src='../images/ver.png' width='100%'></a></td>

  ...
  <!-- Toggle button -->
    ...
    <div style="background:white; margin-top:-32px;" class="bg-red p-5 rounded  shadow-sm ">
        ...
        <p class="lead font-italic mb-0 text-muted">
			<h4  style="float:left; font-size:5vh;font-size:2.5vw;   " > Formas De Conformar Grupos </h4>
    ...
    Es importante explicar, que un grupo no es sólo un agrupamiento de personas, ya
que como seres sociales pueden formar grupos en su ámbito de estudio o mismo en
su vida cotidiana, y además desarrollar una o más tareas, algo por resolver entre ellos,
así como la conciencia de pertenecer al mismo, que es fundamental porque provee de
modelos, normas, valores, etcétera. Lo mencionado es esencial porque todo ser
humano necesita de la compañía de otros; es relevante que cada miembro sea
aceptado por los otros gracias a sus características individuales ya que todos tienen la
necesidad de estima, es decir, ser apreciado por el grupo. Debido a esto, se puede
decir que realizando las actividades en forma grupal los aprendices, pueden llegar a
lograr lo mencionado ya que tienen un doble ejercicio: además de realizar la tarea
pautada, tienen la posibilidad de conocerse porque se establece una interacción
profunda entre ellos centrada en la comunicación que es la herramienta más
importante y gracias a ella se potenciará la cohesión. La suma de estos factores
permitirá tener la conciencia de pertenecer, de confirmación por los otros miembros y
de estima. Por ende, como primera medida se puede decir que los aprendices
formando grupos tienen una oportunidad única que no la da la individualidad que es
interactuar con otros, sentir la pertenencia, identidad grupal, el ser querido, entre
otros.
    </p>	
	</div>
  ...
  <div class="row  w3-white">
      ...
      <form action="buscarEquipos.php" method="get" class="form-inline my-2 my-lg-0" >
       ...
       <button name="b1"  class="btn btn-outline-warning ">Buscar</button>&nbsp;    &nbsp;    
			       ...
			       <?php  include('paginado/paginadoConfor.php'); ?>
...
<form action="buscarGruposPdf.php" method="get" class="form-inline my-2 my-lg-0" >
...
<?php  include('paginado/paginadoConforpdf.php'); ?>
 ...
 <div id="imageViewer" class="viewer" style="display: none; align-content:center; justify-content:center; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0, 0, 0, 0.8); justify-content: center; align-items: center; flex-direction: column; z-index: 1000;">
        ...
        <div class="viewer-controls" style="margin-top: 20px; display: flex; gap: 10px;">
            ...
            <a id="downloadImage" href="#" download style="background-color: #333; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-size: 16px;">Descargar</a>
				...
				<!-- <a href="../pdf/COìMO_DIVIDIR-EN-EQUIPOS_PARAPDF.pdf"> <button  style="width:100%; margin-top:5%;" type="button" class="btn btn-outline-success " > Descargar FICHA TÉCNICA FORMAS DE CONFORMAR GRUPOS <svg width="2em" height="1em" viewBox="0 0 16 16" class="bi bi-cloud-download" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<a href="pdfGrupos.php"> <button  style="width:100%; margin-top:5%; " type="button" class="btn btn-outline-success  " > Descargar RESUMEN  FORMAS DE CONFORMAR GRUPOS <svg width="2em" height="1em" viewBox="0 0 16 16" class="bi bi-cloud-download" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M4.406 1.342A5.53 5.53 0 0 1 8 0c2.69 0 4.923 2 5.166 4.579C14.758 4.804 16 6.137 16 7.773 16 9.569 14.502 11 12.687 11H10a.5.5 0 0 1 0-1h2.688C13.979 10 15 8.988 15 7.773c0-1.216-1.02-2.228-2.313-2.228h-.5v-.5C12.188 2.825 10.328 1 8 1a4.53 4.53 0 0 0-2.941 1.1c-.757.652-1.153 1.438-1.153 2.055v.448l-.445.049C2.064 4.805 1 5.952 1 7.318 1 8.785 2.23 10 3.781 10H6a.5.5 0 0 1 0 1H3.781C1.708 11 0 9.366 0 7.318c0-1.763 1.266-3.223 2.942-3.593.143-.863.698-1.723 1.464-2.383z"/>
  <path fill-rule="evenodd" d="M7.646 15.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 14.293V5.5a.5.5 0 0 0-1 0v8.793l-2.146-2.147a.5.5 0 0 0-.708.708l3 3z"/>
</svg> </button> </a> <br>
           </div>

...
<div class="vertical-nav bg-white" id="sidebar">
 ...
 <BR>
 <div class="video1">
            <iframe src="https://app.emaze.com/@ALWRRTRF/actividades-de-reflexion-inicial-guia-de-aprendizaje"  style="width: 1020px; height: 1000px; transform: scale(0.25); transform-origin: 0 0;"seamless webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
				</div>
<style>
		.video1{
	/* background:green; */
...
<div class="w3-content w3-white" style="width:100%; display:block;">
  ...
  <!-- Grid -->
  <div class="w3-row w3-padding w3-border"  style="width: 100%;">
  ...
  <form action="buscarReflexion.php" method="get" class="form-inline my-2 my-lg-0" >
	   ...
	   <a href="tdaReflexion.php"> <button  width="20%" class="btn btn-warning text-dark " > Mostrar todas </button></a>
   </form><br>

...
if ($result->num_rows > 0){
	...
	$query = "SELECT DISTINCT * FROM rompehielos";
	...
	while($row = $result->fetch_assoc())
	{
		...
		$pdf->Cell(78,7,utf8_decode($row['tituloRompeH']),0,1,'B');
		$pdf->MultiCell(190,5,utf8_decode($row['descripcionRompe']) ,0,2,);
	
		$imagen="../images/".$row['imagenRpmpeH'];

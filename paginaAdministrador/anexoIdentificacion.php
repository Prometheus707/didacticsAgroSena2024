...
<h4 class="" style="float:left; font-size:5vh;font-size:2.5vw;   " > Anexos de identificación del conocimiento </h4>
...
<center>
  <?php
        ...
        $consulta = "SELECT * FROM tda where idTipoTdas='2'";
        ...
        if ($resultado->num_rows > 0 ){
            ...
            <div class='w3-half'><td><a href=../pdf/".$fila["enlace"]."><div style='font-size:20px;'>".$fila["enlace"]."</div></a></td></div>

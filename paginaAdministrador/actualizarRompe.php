...
<html lang="en" dir="ltr">
  ...
  <hr><div class="w3-row w3-padding " >
	 ...
	 <div class="w3-col l6 s12">
      ...
      <center>
     <div class="w3-white ">
					Nombre: <textarea name="nombre" style="width:100%" rows="2" cols="80"><?php echo $fila['tituloRompeH'] ?></textarea>
      </div>
    </center><br><br><br>
      <div class="w3-white ">
        <p>Por favor vuelva a elegir la gráfica para que sea cargada nuevamente.</p>
     Gráfica:<br><br> <input type="file" name="grafica" value="" id="archivoInput" onchange="return validarExt()" required>
 </div><br><br><br><br>
...
<?php } ?>
    ...
    <footer style="background-color: #39A900;  margin-top:-2%;">

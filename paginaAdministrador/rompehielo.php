...
<div class="w3-content w3-white" style="width:100%; display:block; margin-bottom:1.5rem;">
 ...
 <div class="w3-col l6 w3-green subirn2">
    ...
    <a href="https://epcagropecuariocauca.blogspot.com/"> <button  style="width:100%; margin-top:5%;font-size:17px" type="button" class="btn btn btn-outline-success  " >Banco de recursos didácticos <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-bar-right" fill="currentColor" xmlns="http://www.w3.org/2000/svg">

...
<div class="page-content p-5" id="content">
  <!-- Toggle button -->
   ...
   <h4 class="" style="float:left; font-size:5vh;font-size:2.5vw;   " > Como armar equipos</h4>
	  <a href="tdaEquipos.php"> <button style="float:right" width="60%" class="btn btn-danger text-light " > &nbsp&nbsp&nbsp Volver &nbsp&nbsp&nbsp </button></a>
        ...
        <?php
                ...
                echo "<table border='1'  class='table table-bordered table-hover'>
                 <thead> <tr>
                   ...
                   <th class='t4' style='background:#29a900; color:white;width:9%; text-align:center'>Gráfica</th>
              ...
              if ($resultado->num_rows > 0 ){
                  ...
                  <td> <a href='actualizarEquipos.php?id=".$fila['idConfor']."'><input  class='btn btn-success' style='color: white; font-size: 14px' type='button' value=' Actualizar'></a></td>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" >
          ...
          <form  class="" enctype="multipart/form-data"  onSubmit="return validar();" action="añadirtda/añadirEquipos.php" method="post">
            ...
            <p style="font-size: 18px;">    Descripción:</p><textarea name="descripcion" style="width:100%;height:20%" rows="6" cols="80" required></textarea><br><br><br>

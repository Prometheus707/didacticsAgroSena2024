      ...
      <div id="tablephp">
        <?php
              ...
              if ($resultado->num_rows > 0 ){
                  ...
                  <td> <a href='actualizarApropia.php?id=".$fila['idTda']."'> <input  class='btn btn-success' style='color: white; font-size: 14px' type='button' value=' Actualizar'></a></td>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" >
          ...
          <form  class="" enctype="multipart/form-data"  onSubmit="return validar();" action="añadirtda/añadirTdaA.php" method="post">
          ...
          <textarea type="text" class="form-control" style="width: 80%;margin-left: 4%" name="descripcion" value="" required></textarea>
...
<div  style="margin-left: 4%" >
        <label for="op1">  <input type="checkbox" id="op1" name="momento[]" value="1"> Reflexión Inicial </label>
          <label for="op2">  <input type="checkbox" id="op2" name="momento[]" value="2" > Contextualización e
		 identificación del conocimiento  </label>

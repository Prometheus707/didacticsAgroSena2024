...
$sql = "UPDATE conformargpdf SET nombreConforPdf='$nombre',descripcionCoPdf='$descripcion',pdfConfor='$nombreArchivo', anexoConfor='$nombreArchivos'  WHERE idConforPdf=".$id;

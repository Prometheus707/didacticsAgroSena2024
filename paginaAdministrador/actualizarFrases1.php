...
// este es el codigo de guardar diferentes tipos de archivos //
		...
		if ( move_uploaded_file ( $nombreTmpArchivo , "../pdf/$nombreArchivo" )) {
				header('location: frases.php?opcion8=true');
			} else{
...
$sql = "UPDATE frases SET nombreFrases='$nombre',descripcionFrases='$descripcion',pdfFrases='$nombreArchivo',anexoF='$nombreArchivos' WHERE idFrases=".$id;

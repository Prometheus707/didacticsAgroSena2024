...
<html lang="en" dir="ltr">
  ...
  <hr><div class="w3-row w3-padding " >
	 ...
	 <div class="w3-col l6 s12">
      ...
      <center>
     <div class="w3-white ">
					Nombre: <textarea name="nombre" style="width:100%" rows="2" cols="80"><?php echo $fila['nombreConforPdf'] ?></textarea>
      </div>
    </center><br>
      <div class="w3-white ">
        <p>Por favor vuelva a elegir el pdf para que sea cargado nuevamente.</p>
    <b>Pdf:</b> <br> <input type="file" name="grafica" value="" id="archivoInput" onchange="return validarExt()" required><br><br>

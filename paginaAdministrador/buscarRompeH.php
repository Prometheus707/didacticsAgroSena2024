...
<div class="page-content p-5" id="content">
  <!-- Toggle button -->
   ...
   <h4 class="" style="float:left; font-size:5vh;font-size:2.5vw;   " > Rompe Hielo</h4>
	  <a href="tdaRompe.php"> <button style="float:right" width="60%" class="btn btn-danger text-light " > &nbsp&nbsp&nbsp Volver &nbsp&nbsp&nbsp </button></a>
      ...
      <div id="tablephp">
        <?php
                ...
                echo "<table border='1'  class='table table-bordered table-hover'>
                 <thead> <tr>
                   <th class='t2' style='background:#29a900; color:white; width:41%; text-align:center'>Nombre</th>
                   <th class='t3' style='background:#29a900; color:white; width:45%; text-align:center'>Descripción</th>
                   <th class='t4' style='background:#29a900; color:white;width:12%; text-align:center'>Gráfica</th>
              ...
              if ($resultado->num_rows > 0 ){
                  ...
                  <td> <a href='actualizarRompe.php?id=".$fila['idRompeH']."'>  <input  class='btn btn-success' style='color: white; font-size: 14px' type='button' value=' Actualizar'></a></td>

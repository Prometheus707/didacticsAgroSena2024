 ...
 mysqli_set_charset($conecta,"utf8");
  echo "<table border='1'  class='table table-bordered table-hover'>
                  <thead> <tr>
                   ...
                   <th class='nt3' style='background:#29a900; color:white; width:51%; text-align:center'>Descripción</th>
  ...
  while($rows = $c->fetch_assoc())
  {
    ...
    echo "<td>".$rows['descripcionConf']."</td>
          ...
          <td> <a href='actualizarEquipos.php?id=".$rows['idConfor']."'> <input  class='btn btn-success' style='color: white; font-size: 14px' type='button' value=' Actualizar'></a></td>
          <td> <a href='eliminarEquipos.php?id=".$rows['idConfor']."'>  <input  class='btn btn-danger' style='color: white; font-size: 14px' type='button' value=' Eliminar'></a></td>

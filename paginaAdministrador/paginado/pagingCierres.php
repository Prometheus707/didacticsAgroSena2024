...
$count="SELECT COUNT(*) FROM reflexioncierre";
 ...
 mysqli_set_charset($conecta,"utf8");
  echo "<table border='1'  class='table table-bordered table-hover'>
                  <thead> <tr>
                   ...
                   <th class='nt3'style='background:#29a900; color:white; width:41%; text-align:center'>Descripción</th>
                	<th class='nt4'style='background:#29a900; color:white;width: 1%; text-align:center'>Gráfica</th>
  ...
  while($rows = $c->fetch_assoc())
  {
    ...
    <td> <a href='actualizarCierre.php?id=".$rows['idReflexionC']."'>  <input  class='btn btn-success' style='color: white; font-size: 14px' type='button' value=' Actualizar'></a></td>";

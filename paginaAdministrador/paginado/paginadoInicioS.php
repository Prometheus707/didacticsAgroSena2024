...
$count="SELECT COUNT(*) FROM iniciosesion";
 ...
 mysqli_set_charset($conecta,"utf8");
  echo "<table border='1'  class='table table-bordered table-hover'>
                  <thead> <tr>
                   <th class='nt2'   style='background:#29a900; color:white; width:35%; text-align:center'>Nombre</th>
  ...
  while($rows = $c->fetch_assoc())
  {
    ...
    echo "<td>".$rows['descripcionInicioS']."</td>
          ...
          <td style='text-align:center'><a href=../pdf/".$rows["pdfInicioS"]."><img src='../images/ver.png' width='50%'></a></td>
           <td> ".$enlaceHref." ". $no_pdf ."</a></td>
          <td> <a href='actualizarSesion.php?id=".$rows['idIniciosesion']."'><input  class='btn btn-success' style='color: white; font-size: 14px' type='button' value=' Actualizar'></a></td>
          
          <td> <a href='eliminarSesion.php?id=".$rows['idIniciosesion']."'> <input  class='btn btn-danger' style='color: white; font-size: 14px' type='button' value=' Eliminar'></a></td>
    ...
    if(['idIniciosesion'] < $id ) {
      ...
      echo "<td>".$rows['descripcionInicioS']."</td>
            ...
            <td style='text-align:center'><a href=../pdf/".$rows["pdfInicioS"]."><img src='../images/ver.png' width='5  0%'></a></td>
             <td> ".$enlaceHref." ". $no_pdf ."</a></td>
            <td> <a href='actualizarSesion.php?id=".$rows['idIniciosesion']."'><input  class='btn btn-success' style='color: white; font-size: 14px' type='button' value=' Actualizar'></a></td>

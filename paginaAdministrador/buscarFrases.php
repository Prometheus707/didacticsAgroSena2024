...
<div class="page-content p-5" id="content">
  <!-- Toggle button -->
   ...
   <h4 class="" style="float:left; font-size:5vh;font-size:2.5vw;   " > Frases En Positivo Para Usar</h4>
	  <a href="frases.php"> <button style="float:right" width="60%" class="btn btn-danger text-light " > &nbsp&nbsp&nbsp Volver &nbsp&nbsp&nbsp </button></a>
        ...
        <?php
                ...
                echo "<table border='1'  class='table table-bordered table-hover'>
                 <thead> <tr>
                   ...
                   <th class='t3' style='background:#29a900; color:white; width:41%; text-align:center'>Descripción</th>
              ...
              where
              nombreFrases like '%$busqueda%' OR
              descripcionFrases like '%$busqueda%'
              ";
              ...
              if ($resultado->num_rows > 0 ){
                  while($fila = $resultado->fetch_assoc()) {
                    if( $fila['idFrases'] ) {
                      ...
                      $varCadena = strlen ($fila["anexoF"]);
                      if($varCadena>0)
                      {
                        $enlaceHref = " <a href=../pdf/".$fila["anexoF"]."> ";
                  ...
                  <td> ".$fila["nombreFrases"]."</td>
                  <td> ".$fila['descripcionFrases']."</td>
                  <td style='text-align:center'><a href=../pdf/".$fila["pdfFrases"]."><img src='../images/ver.png' width='50%'></a></td>
                   <td> ".$enlaceHref." ". $no_pdf ."</a></td>
                  <td> <a href='actualizarFrases.php?id=".$fila['idFrases']."'><input  class='btn btn-success' style='color: white; font-size: 14px' type='button' value=' Actualizar'></a></td>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" >
          ...
          <form  class="" enctype="multipart/form-data"  onSubmit="return validar();" action="añadirtda/añadirFrases.php" method="post">

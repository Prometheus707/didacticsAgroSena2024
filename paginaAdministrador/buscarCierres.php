...
<div class="page-content p-5" id="content">
  <!-- Toggle button -->
   ...
   <h4 class="" style="float:left; font-size:5vh;font-size:2.5vw;   " > Reflexiones y cierres</h4>
	  <a href="tdaCierres.php"> <button style="float:right" width="60%" class="btn btn-danger text-light " > &nbsp&nbsp&nbsp Volver &nbsp&nbsp&nbsp </button></a>
      ...
      <div id="tablephp">
        <?php
                ...
                echo "<table border='1'  class='table table-bordered table-hover'>
                 <thead> <tr>
                   <th class='t2' style='background:#29a900; color:white; width:31%; text-align:center'>Nombre</th>
                   <th class='t3'  style='background:#29a900; color:white; width:35%; text-align:center'>Descripción</th>
                   <th class='t4' style='background:#29a900; color:white;width:10%; text-align:center'>Gráfica</th>
              ...
              $consulta = "SELECT * FROM reflexioncierre
              where
              tituloRef like '%$busqueda%' OR
              descripcionRef like '%$busqueda%'
              ";
              ...
              if ($resultado->num_rows > 0 ){
                  ...
                  <td> ".$fila["tituloRef"]."</td>
                  <td> ".$fila['descripcionRef']."</td>
                  <td> <img    class='zoom' src='../images/".$fila["imagenRef"]." '> </td>
                  <td> <a href='actualizarCierre.php?id=".$fila['idReflexionC']."'><input  class='btn btn-success' style='color: white; font-size: 14px' type='button' value=' Actualizar'></a></td>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" >
          ...
          <form  class="" enctype="multipart/form-data"  onSubmit="return validar();" action="añadirtda/añadirCierres.php" method="post">

            <p style="font-size: 18px;"> Nombre:</p> <textarea name="nombre" style="width:100%; height:10%" rows="1" cols="80" required></textarea> <br>

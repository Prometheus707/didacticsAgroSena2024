...
<?php
  ...
  $busqueda=strtolower($_REQUEST['busqueda']);
   if(empty($busqueda)){
     header("location: tdaReflexion.php");
   }
...
<div class="vertical-nav bg-white" id="sidebar">
  ...
  <ul class="nav flex-column bg-white mb-0">
    <li class="nav-item">
      <a style="background:<?php echo $var_color_sena; ?>; color:white;" href="administrador.php" id="miBoton" class="nav-link text-white ">
  ...
  <ul class="nav flex-column bg-white mb-0">
  <div class="video1">
             <iframe src="https://app.emaze.com/@ALWRRTRF/actividades-de-reflexion-inicial-guia-de-aprendizaje"  style="width: 258px; height: 300px;transform-origin: 0 0;"seamless webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
				</div>
<style>
		.video1{
	/* background:green; */
...
<div class="page-content p-5" id="content">
  <!-- Toggle button -->
	...
	<h4 class="" style="float:left; font-size:5vh;font-size:2.5vw;   " >  Reflexión Inicial</h4>
		  <a href="tdaReflexion.php"> <button style="float:right" width="60%" class="btn btn-danger text-light " > &nbsp&nbsp&nbsp Volver &nbsp&nbsp&nbsp </button></a>
...
<div class="w3-content w3-white" style="width:100%; display:table">
  ...
  <form action="buscarReflexion.php" method="get" class="form-inline my-2 my-lg-0" style=" float:right; margin-top:-50%;">
      ...
      <div id="tablephp"  >
        <?php
                ...
                echo "<table border='1'  class=' table table-bordered table-hover'>
                   <thead> <tr>
                   <th class='t2'  style='background:#29a900; color:white; width:51%; text-align:center' >Nombre</th>
                   <th class='t3' style='text-align:center font-size:9px;padding-left:15%;'>Descripción</th>
                   <th class='t5' style='background:#29a900; color:white;width:5%; text-align:center''>Archivo</th>
                    <th class='t5' style='background:#29a900; color:white;width:5%; text-align:center''>Anexo</th>
					<th class='t5'>Actualizar</th>
              ...
              if ($resultado->num_rows > 0 ){
                  ...
                  <td><a href=../pdf/".$fila["rutaPDF"]."><img src='../images/ver.png' width='50%'></a></td>
                   <td> ".$enlaceHref." ". $no_pdf ."</a></td>
                  <td> <a href='actualizarRefle.php?id=".$fila['idTda']."'> <input  class='btn btn-success' style='color: white; font-size: 15px' type='button' value=' Actualizar'></a></td>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form  class="" enctype="multipart/form-data"  onSubmit="return validar();" action="añadirtda/añadirTda.php" method="post">
            <p style="font-size: 18px;padding-left: 4%;">Nombre Tda:</p>
          ...
          <textarea type="text" class="form-control" style="width: 80%;margin-left: 4%" name="descripcion" value="" required></textarea><br>

        ...
        <?php
                ...
                echo "<table border='1'  class='table table-bordered table-hover'>
                  <thead> <tr>
                   ...
                   <th class='t5' style='background:#29a900; color:white;width:1%; text-align:center'>Archivo</th>
                   <th class='t5' style='background:#29a900; color:white;width:1%; text-align:center'>Anexo</th>
					<th class='t5' style='background:#29a900; color:white;width:1%; text-align:center'>Actualizar</th>
              ...
              if ($resultado->num_rows > 0 ){
                  ...
                  <td> <a href='actualizarTransfe.php?id=".$fila['idTda']."'><input  class='btn btn-success' style='color: white; font-size: 14px' type='button' value=' Actualizar'></a></td>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" >
          ...
          <form  class="" enctype="multipart/form-data"  onSubmit="return validar();" action="añadirtda/añadirTdaT.php" method="post">
...
<div style="margin-left: 4%" >
        <label for="op1">  <input type="checkbox" id="op1" name="momento[]" value="1"> Reflexión Inicial </label>
          <label for="op2">  <input type="checkbox" id="op2" name="momento[]" value="2" > Contextualización E Identificación de conocimientos necesarios para el aprendizaje </label>

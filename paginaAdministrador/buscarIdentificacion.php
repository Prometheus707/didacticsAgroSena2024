...
<?php
  ...
  $busqueda=strtolower($_REQUEST['busqueda']);
   if(empty($busqueda)){
     header("location: tdaIdentificacion.php");
   }
...
<div class="page-content p-5" id="content">
  <!-- Toggle button -->
   ...
   <h4 class="" style="float:left; font-size:5vh;font-size:2.5vw;   " > Contextualización e Identificación Del Conocimiento</h4>
	  <a href="tdaIdentificacion.php"> <button style="float:right" width="60%" class="btn btn-danger text-light " > &nbsp&nbsp&nbsp Volver &nbsp&nbsp&nbsp </button></a>
        ...
        <?php
                ...
                echo "<table border='1'  class='table table-bordered table-hover'>
                 <thead> <tr>
                   ...
                   <th class='t3'  style='background:#29a900; color:white; width:31%; text-align:center'>Descripción</th>
              ...
              if ($resultado->num_rows > 0 ){
                  ...
                  <td> <a href='actualizarContex.php?id=".$fila['idTda']."'> <input  class='btn btn-success' style='color: white; font-size:15px' type='button' value=' Actualizar'></a></td>
  ...
  <div class="modal fade" id="myModal3" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form  class="" enctype="multipart/form-data"  onSubmit="return validar();" action="añadirtda/añadirTdaC.php" method="post">
            <p style="font-size: 18px;padding-left: 4%;">Nombre Técnica Didáctica Activa:</p>
          <input type="text" style="width: 80%;margin-left: 4%" class="form-control" name="nombre" value="" required>

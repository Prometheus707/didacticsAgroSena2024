  ...
  <ul class="nav flex-column bg-white mb-0">
    <li class="nav-item" id="padre7">
      <a href="administrador.php" id="miBoton" class="nav-link ">
                <i  id="otro_div7"  class="fa fa-th-large mr-3  fa-fw"></i>
                Técnicas Didácticas
            </a>
          </li>
...
<center>
            <?php
                    ...
                    echo "<table border='1' class=' table-bordered table-hover'>
                      ...
                      <th  class='t7' style='background:#29a900; color:white; width:14%; text-align:center'>Archivo</th>
                      <th  class='t8' style='background:#29a900; color:white; width:1%; text-align:center'>ATENDER</th>
              <th  class='t9' style='background:#29a900; color:white; width:1%; text-align:center'>ELIMINAR</th>
                  ...
                  if ($resultado->num_rows > 0 ){
                      ...
                      echo "<tr  style='text-align:center;'>
                            ...
                            <td  style='text-align: center'> <a href='atenderSugerencia.php?id=".$fila["idSugerencia"]."'>  <button style='color: black;' class='btn btn-warning'  type='button'  '> Atender </button> </a></td>
                            <td  style='text-align: center'> <a href='eliminarSugerencia.php?id=".$fila["idSugerencia"]."'>  <button style='color: white;' class='btn btn-danger'  type='button'   onclick='return ConfirmDelet()'> Eliminar </button> </a></td>

...
<div class="page-content p-5" id="content">
  <!-- Toggle button -->
   ...
   <h4 class="" style="float:left; font-size:5vh;font-size:2.5vw;   " > Jolts y Motivadores</h4>
	  <a href="tdaJolts.php"> <button style="float:right" width="60%" class="btn btn-danger text-light " > &nbsp&nbsp&nbsp Volver &nbsp&nbsp&nbsp </button></a>
  ...
  <form action="buscarJolts.php"method="get" class="form-inline my-2 my-lg-0" style=" float:right; margin-top:-50%;">
      ...
      <div id="tablephp">
        <?php
              ...
              $consulta = "SELECT * FROM motivdores
              where
              tituloMoti like '%$busqueda%' OR
              descripcionMoti like '%$busqueda%'
              ";
              ...
              if ($resultado->num_rows > 0 ){
                  ...
                  <td> ".$fila["tituloMoti"]."</td>
                  <td> ".$fila['descripcionMoti']."</td>
                  <td> <img    class='zoom' src='../images/".$fila["imagenMoti"]." '> </td>
                  <td> <a href='actualizarJolts.php?id=".$fila['idMotivadores']."'>  <input  class='btn btn-success' style='color: white; font-size: 14px' type='button' value=' Actualizar'></a></td>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" >
          ...
          <form  class="" enctype="multipart/form-data"  onSubmit="return validar();" action="añadirtda/añadirJolts.php" method="post">
